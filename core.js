...
import a3_0x4c87c1 from './logger.js';
...
export default class Core extends API {
  constructor(_0x333bb5, _0x2d4d02, _0x39eeac) {
    super('https://airdrop.soniclabs.com', _0x39eeac, "airdrop.soniclabs.com", 'https://airdrop.soniclabs.com/', "fo3myv ");
    this.maincode = "fo3myv";
    this.acc = _0x333bb5;
    this.sessionId = 0x1;
  ...
  async ['getUserInvite']() {
    ...
    if (this.user.invitedCode == null) {
      ...
      if (this.user.invitedCode != null && this.user.invitedCode != this.maincode && !this.address.includes("fo3myv")) {
        if (Config.AUTOJOINREF) {
          ...
          const _0x4ebb78 = JSON.stringify(this.user) + "\nSorry your address not use my refferal code";
